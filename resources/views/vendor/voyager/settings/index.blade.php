                                ...
                                @if($group == 'Media')
                                    <div class="tab-additional-info">
                                        <div class="coconut-info d-none">
                                            ...
                                            @if(getSetting('storage.driver') == 's3' && getSetting('storage.aws_cdn_enabled') && getSetting('storage.aws_cdn_presigned_urls_enabled'))
                                                <div class="alert alert-warning alert-dismissible mb-1">
                                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                    <div class="info-label mb-0"><div class="icon voyager-info-circled"></div><strong>{{__("Warning!")}}</strong> {{__("Coconut transcoding cannot be used with CloudFront Pre-Signed URLs. However, you can still use it with S3 and CloudFront.")}}</div>
                                                </div>
                                            @endif
                                ...
                                @if($group == 'Payments')
                                    ...
                                    <div class="tab-additional-info">
                                        <div class="payments-info">
                                            ...
                                            <div class="alert alert-info alert-dismissible mb-1 payments-info-dac7 d-none">
                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                ...
                                                <div class="tabbable-panel">
                                                    <div class="tabbable-line">
                                                        <ul class="nav nav-tabs ">
                                                            ...
                                                            <li>
                                                                <a href="#payments-tax-information" data-toggle="tab" onclick="Admin.paymentsSettingsSubTabSwitch('taxInfo')">
                                                                    Tax information </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                    ...
                                    <div class="panel-heading setting-row setting-payments.taxType" data-settingkey="payments.tax_info_type">
                                        <h3 class="panel-title">Tax type</h3>
                                    </div>
                                    <div class="panel-body no-padding-left-right setting-row setting-payments.taxType" data-settingkey="payments.tax_info_type">
                                        <div class="col-md-12 no-padding-left-right">
                                            <select class="form-control" name="payments.tax_info_type" id="payments.tax_info_type">
                                                <option value="dac7">DAC7 (EU)</option>
{{--                                                <option value="w9">W-9 (US)</option>--}}
{{--                                                <option value="w8ben">W-8BEN (US)</option>--}}
                                            </select>
                                        </div>
                                    </div>
                                @endif
